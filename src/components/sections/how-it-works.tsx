...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="bg-[#141819]">
...
function StepCard({ step }: { step: Step }) {
  ...
  return (
    <article className="relative h-[508px] overflow-hidden rounded-[4px] bg-[#1e2526] shadow-[0px_0px_16px_0px_rgba(4,27,32,0.04)]">
      <Art />
      ...
      {mask && (
        <div
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-[374px] z-[5] h-[184px] w-[559px] -translate-x-1/2 bg-[#1e2526] blur-[26.85px]"
        />
      )}
