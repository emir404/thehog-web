...
function FeatureCard({ title, description, children, className }: FeatureCardProps) {
  return (
    <div
      className={cn(
        "relative h-[384px] overflow-hidden rounded-[4px] bg-white shadow-[0px_0px_16px_0px_rgba(34,12,1,0.04)]",
        className,
      )}
    >
      ...
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center gap-16 px-6 py-24 sm:gap-20 sm:py-32 lg:px-[120px]">
        <FadeIn>
          <div className="flex flex-col items-center gap-6">
            <span className="inline-flex items-center justify-center rounded-full border border-[#1b1918]/[0.08] bg-white px-3.5 py-3 text-[12px] leading-none text-ink-deep/80 shadow-[0_6px_8px_rgba(34,12,1,0.03)]">
              FEATURES
            </span>
